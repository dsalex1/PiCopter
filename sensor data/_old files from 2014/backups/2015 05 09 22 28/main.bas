...
do
	...
	curentmotorspeeds=PID(,,,curentOrientation.Roll*0,curentOrientation.Pitch*0,0,curentuserinput.roll,curentuserinput.pitch,curentuserinput.yaw,curentuserinput.power)  'let the PID controller calculate the motorspeeds and store them in motorspeeds (range 0 to 100)
