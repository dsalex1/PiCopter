...
void LSM6::readAcc(void)
{
  ...
  uint8_t xla = wiringPiI2CReadReg8 (fd, OUTX_L_XL);
  uint8_t xha = wiringPiI2CReadReg8 (fd, OUTX_L_XL+1);
  uint8_t yla = wiringPiI2CReadReg8 (fd, OUTX_L_XL+2);
  uint8_t yha = wiringPiI2CReadReg8 (fd, OUTX_L_XL+3);
  uint8_t zla = wiringPiI2CReadReg8 (fd, OUTX_L_XL+4);
  uint8_t zha = wiringPiI2CReadReg8 (fd, OUTX_L_XL+5);
  close(fd);
...
void LSM6::readGyro(void)
{
  ...
  uint8_t xlg = wiringPiI2CReadReg8 (fd, OUTX_L_G);
  uint8_t xhg = wiringPiI2CReadReg8 (fd, OUTX_L_G+1);
  uint8_t ylg = wiringPiI2CReadReg8 (fd, OUTX_L_G+2);
  uint8_t yhg = wiringPiI2CReadReg8 (fd, OUTX_L_G+3);
  uint8_t zlg = wiringPiI2CReadReg8 (fd, OUTX_L_G+4);
  uint8_t zhg = wiringPiI2CReadReg8 (fd, OUTX_L_G+5);
  close(fd);
  // combine high and low bytes
