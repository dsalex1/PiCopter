...
class LSM6DS33(I2C):
    ...
    def enable(self, calibration=True, accelerometer=True, gyroscope=True):
    ...
    def get_accelerometer_angles(self,calibrated=0, round_digits=0):
        ...
        if self.is_accel_calibrated and calibrated!=0:
